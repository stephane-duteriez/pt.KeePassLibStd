...
namespace KeePassLib.Utility
{
    ...
    public static class StrUtil
	{
		...
		public static string ColorToUnnamedHtml(
            System.Drawing.Color color, bool bEmptyIfTransparent)
		{
...
#if NETSTANDARD2_0
                CryptoUtil.Salt = m_pbOptEnt;
                byte[] pbEnc = Encoding.UTF8.GetBytes(CryptoUtil.
                    EncryptStringAES(strPlainText, CryptoUtil.SharedSecret));
#else
...
#if NETSTANDARD2_0
                CryptoUtil.Salt = m_pbOptEnt;
                return CryptoUtil.DecryptStringAES(
                    Encoding.UTF8.GetString(pbEnc), CryptoUtil.SharedSecret);
#else
